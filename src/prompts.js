...
export const transform_messages_into_research_topic_prompt = `You will be given a set of messages that have been exchanged so far between yourself and the user. 
...
export const research_agent_prompt = `You are a research assistant conducting research on the user's input topic. For context, today's date is {date}. 
<Task> 
...
export const summarize_webpage_prompt = `You are tasked with summarizing the raw content of a webpage retrieved from a web search. Your goal is to create a summary that preserves the most important information from the original web page. This summary will be used by a downstream research agent, so it's crucial to maintain the key details without losing essential information. 
...
export const research_agent_prompt_with_mcp = `You are a research assistant conducting research on the user's input topic using local files. For context, today's date is {date}. 
<Task> 
...
export const lead_researcher_prompt = `You are a research supervisor. Your job is to conduct research by calling the "ConductResearch" tool. For context, today's date is {date}. 
<Task> 
...
export const compress_research_system_prompt = `You are a research assistant that has conducted research on a topic by calling several tools and web searches. Your job is now to clean up the findings, but preserve all of the relevant statements and information that the researcher has gathered. For context, today's date is {date}. 
<Task> 
...
export const compress_research_human_message = `All above messages are about research conducted by an AI Researcher for the following research topic: 
...
export const final_report_generation_prompt = `Based on all the research conducted, create a comprehensive, well-structured answer to the overall research brief: 
<Research Brief> 
{research_brief} 
</Research Brief> 
...
export const BRIEF_CRITERIA_PROMPT = ` 
<role> 
...
export const BRIEF_HALLUCINATION_PROMPT = ` 
...
// Optional CommonJS export (uncomment if you prefer CommonJS):
// module.exports = {
